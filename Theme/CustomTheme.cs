...
namespace Theme
{
    ...
    public class CustomTheme : AvaloniaObject, IStyle, IResourceProvider
    {
        ...
        public static readonly StyledProperty<FluentThemeMode> ModeProperty =
            AvaloniaProperty.Register<CustomTheme, FluentThemeMode>(nameof(Mode));
        /// <summary>
        ...
        private void InitStyles(Uri baseUri)
        {
            _sharedStyles = new Styles
            {
                ...
                {
                    Source = new Uri("avares://Theme/Accents/AccentColors.xaml")
                },
                new StyleInclude(baseUri)
                {
                    Source = new Uri("avares://Theme/Accents/Base.xaml")
                },
                new StyleInclude(baseUri)
                {
                    Source = new Uri("avares://Theme/Controls/FluentControls.xaml")
                }
            };
            ...
            _fluentLight = new Styles
            {
                new StyleInclude(baseUri)
                {
                    Source = new Uri("avares://Theme/Accents/BaseLight.xaml")
                },
                new StyleInclude(baseUri)
                {
                    Source = new Uri("avares://Theme/Accents/FluentControlResourcesLight.xaml")
                }
            };
            ...
            _fluentDark = new Styles
            {
                new StyleInclude(baseUri)
                {
                    Source = new Uri("avares://Theme/Accents/BaseDark.xaml")
                },
                new StyleInclude(baseUri)
                {
                    Source = new Uri("avares://Theme/Accents/FluentControlResourcesDark.xaml")
                }
            };
        }
    }
